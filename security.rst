...
documented `here <https://singularity.hpcng.org/\{adminversion\}/configfiles.html>`__. 
...
file and cgroups are configured accordingly. More about cgroups support `here <https://singularity.hpcng.org/\{adminversion\}/configfiles.html#cgroups-toml>`__.
...
grained control of security. Details about them are documented `here <https://singularity.hpcng.org/\{adminversion\}/security_options.html>`__.
