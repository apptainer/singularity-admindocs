...
.. note::
  ...
  Please see `Linux Capabilities <https://singularity.hpcng.org/user-docs/master/security_options.html#linux-capabilities>`_
...
virtualization
<https://singularity.hpcng.org/user-docs/master/networking.html>`_. Unrestricted
...
that Singularity will use for `Network Virtualization <https://singularity.hpcng.org/user-docs/master/networking.html>`_.

``CNI PLUGIN PATH``:
This option allows admins to specify a custom path for Singularity to access
CNI plugin executables. Check out the `Network Virtualization <https://singularity.hpcng.org/user-docs/master/networking.html>`_
...
`user guide
<https://singularity.hpcng.org/user-docs/master/>`__
...
etc, please check the `Userdocs <https://singularity.hpcng.org/user-docs/master/>`_
and it's `Appendix <https://singularity.hpcng.org/user-docs/master/appendix.html>`_.
...
please check the `Remote Userdocs <https://singularity.hpcng.org/user-docs/master/endpoint.html>`_.
